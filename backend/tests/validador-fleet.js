...
const PODE_DISPARAR = new Set([
    ...
    'COMB-1310-ANP-01',   // (ref. 2033) variação físico×escritural do tanque > 0,6% ANP — ADV, indício comum e legítimo
    'DOC-C190-CFOPUF-01', // (ref. 2742) CFOP interno 1/5 com participante de outra UF — ADV, comum (venda presencial)
    'DOC-C100-SEQ-01',    // (ref. 4028) intervalo na sequência numérica de NF próprias — ADV, comum
    'COMB-1300-1320-01',  // (ref. 2023) VOL_SAIDAS(1300) ≠ Σ VOL_VENDAS(1320) acima da tolerância — ADV, achado real quando dispara
]);
