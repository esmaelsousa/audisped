...
// O nº de campos DEPENDE do COD_VER do 0000:
//   • ≤ 019: 3 campos → `|0220|UNID|FAT|`            → split('|').length = 5
//   • ≥ 020 (2026+): 4 campos → `|0220|UNID|FAT|X|`  → split('|').length = 6 (4º campo do leiaute 020,
//     em geral vazio: `|0220|L|1||`).
// O PVA conta os campos conforme o leiaute: 3 campos num arquivo 020 → "esperado 4, contém 3";
// 4 campos num ≤019 → "esperado 3, contém 4". Por isso a expectativa é por versão.
module.exports = {
    id: 'CAD-0220-01',
    bloco: '0',
    registro: '0220',
    ...
    detectar(model) {
        const erros = [];
        const is020 = String(model.versao || '') >= '020';
