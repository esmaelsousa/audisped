...
// 2026-06-15 via BrasilAPI). COD_MUN = código IBGE de 7 dígitos (campo do 0150). IE em BRANCO
// (instituição de pagamento não tem inscrição estadual; o PVA valida o 0150 com IE vazia — não
// usar "ISENTO"). Semeado com ON CONFLICT DO NOTHING
// → NÃO sobrescreve ajustes que o usuário fizer; é só o padrão de fábrica.
module.exports = [
    { cnpj: '16501555000157', nome: 'STONE INSTITUICAO DE PAGAMENTO S.A', ie: '', cod_mun: '3550308', endereco: 'AVENIDA REBOUCAS', num: '2880', bairro: 'PINHEIROS' },
    { cnpj: '01027058000191', nome: 'CIELO S.A - INSTITUICAO DE PAGAMENTO', ie: '', cod_mun: '3505708', endereco: 'ALAMEDA XINGU', num: '512', bairro: 'ALPHAVILLE CENTRO INDUSTRIAL E EMPRESARIAL' },
    { cnpj: '01425787000104', nome: 'REDECARD INSTITUICAO DE PAGAMENTO S.A.', ie: '', cod_mun: '3550308', endereco: 'RUA TENENTE MAURO DE MIRANDA', num: '36', bairro: 'JABAQUARA' },
