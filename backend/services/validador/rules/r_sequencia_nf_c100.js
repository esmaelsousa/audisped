// DOC-C100-SEQ-01 (E-Auditoria 4028) — Intervalo na sequência numérica de notas fiscais próprias.
// ALERTA (ADV): o E-Auditor considera a combinação (NUM_DOC + COD_MOD + SÉRIE) das notas de EMISSÃO
...
// e notas sem série NÃO entram na análise (regra do próprio E-Auditor). Canceladas/denegadas ocupam
// número (não são lacuna) → contam como presentes.
// Verificado no par casado arq 2028 (S CRUZ 09069475000109 01/2026): E-Auditor 4028 = 17 ocorrências.
module.exports = {
    id: 'DOC-C100-SEQ-01',
    bloco: 'C',
    registro: 'C100',
